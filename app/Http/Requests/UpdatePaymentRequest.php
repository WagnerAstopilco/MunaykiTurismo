...
class UpdatePaymentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'payment_method' => 'sometimes|required|in:tarjeta_credito, tarjeta_debito, transferencia',
            'transaction_id' => 'sometimes|nullable|string|min:4|max:12',
            'status' => 'sometimes|required|string|in:pendiente,completada, fallida',
            'date' => 'sometimes|nullable|date',
            'voucher' => 'sometimes|nullable|string|max:255',
