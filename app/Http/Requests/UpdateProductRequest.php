...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug' => 'sometimes|nullable|string|min:3|max:255|regex:/^[a-z0-9\-\/]+$/|unique:products,slug,' .$productId,
            ...
            'number_of_nights' => 'sometimes|nullable|integer|min:0',
            ...
            'reservation_requirements' => 'sometimes|nullable|string',
            'reservation_included' => 'sometimes|nullable|string',
